...
# Reason: Requires KMS key resource creation and business decision on key management strategy (rotation, sharing, permissions)
...
#      }
#      Note: Ensure IAM permissions allow DynamoDB to use the KMS key

# AGENT-FIXED: CKV_AWS_28 - Enabled point-in-time recovery for continuous backups (last 35 days)
