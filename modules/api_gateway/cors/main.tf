...
# AGENT-FIXED: CKV2_AWS_53 - Added request validator for API Gateway method
resource "aws_api_gateway_request_validator" "cors_validator" {
  name                        = "${var.api_id}-cors-validator"
  rest_api_id                 = var.api_id
  validate_request_body       = false
  validate_request_parameters = false
}

# AGENT-FIXED: CKV2_AWS_53 - Associated request validator with OPTIONS method
