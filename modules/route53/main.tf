...
# Reason: Requires KMS key with specific configuration, multi-resource coordination, and registrar-level DS record updates with high risk of DNS disruption
# Fix: 1. Create KMS key for DNSSEC signing (must use ECC_NIST_P256):
